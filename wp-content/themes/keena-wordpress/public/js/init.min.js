! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], e) : e((t = t || self).bootstrap = {}, t.jQuery) }(this, function(t, p) {
        ...
        g = function() {
            ...
            return t.close = function(t) {
                ...
                var e = m.getSelectorFromElement(t),
                    n = !1;
                return e && (n = document.querySelector(e)), n = n || p(t).closest("." + u)[0]
    ...
    var qt = function(t, e, n) { return e && Kt(t.prototype, e), n && Kt(t, n), t };
    ...
    function Qt(t, e, n) { return e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t }
    var Vt = Object.assign || function(t) { for (var e = 1; e < arguments.length; e++) { var n = arguments[e]; for (var i in n) Object.prototype.hasOwnProperty.call(n, i) && (t[i] = n[i]) } return t };

    function Yt(t) { return Vt({}, t, { right: t.left + t.width, bottom: t.top + t.height }) }
    ...
    function Gt(t) { if (!t || !t.parentElement || Ht()) return document.documentElement; for (var e = t.parentElement; e && "none" === Nt(e, "transform");) e = e.parentElement; return e || document.documentElement }
    ...
    function $t(t, e, n, i, o) {
        ...
        if ("viewport" === i) s = function(t, e) {
            ...
            var c = Xt(l, a, r);
            if ("HTML" !== l.nodeName || function t(e) { var n = e.nodeName; if ("BODY" === n || "HTML" === n) return !1; if ("fixed" === Nt(e, "position")) return !0; var i = kt(e); return !!i && t(i) }(a)) s = c;
            else {
    ...
    function Jt(t, e, i, n, o, r) {
        ...
        var a = $t(i, n, s, o),
            ...
            c = Object.keys(l).map(function(t) { return Vt({ key: t }, l[t], { area: function(t) { return t.width * t.height }(l[t]) }) }).sort(function(t, e) { return e.area - t.area }),
    ...
    function Zt(t, e, n, i) { var o = 3 < arguments.length && void 0 !== i ? i : null; return Xt(n, o ? Gt(e) : Ft(e, n), o) }
    ...
    function ee(t) { var e = { left: "right", right: "left", bottom: "top", top: "bottom" }; return t.replace(/left|right|bottom|top/g, function(t) { return e[t] }) }
    ...
    function ie(t, e) { return Array.prototype.find ? t.find(e) : t.filter(e)[0] }

    function oe(t, n, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, n) { if (Array.prototype.findIndex) return t.findIndex(function(t) { return t[e] === n }); var i = ie(t, function(t) { return t[e] === n }); return t.indexOf(i) }(t, "name", e))).forEach(function(t) {
    ...
    function re(t, n) { return t.some(function(t) { var e = t.name; return t.enabled && e === n }) }
    ...
    function ae(t) { var e = t.ownerDocument; return e ? e.defaultView : window }
    ...
    function ce() { this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate), this.state = function(t, e) { return ae(t).removeEventListener("resize", e.updateBound), e.scrollParents.forEach(function(t) { t.removeEventListener("scroll", e.updateBound) }), e.updateBound = null, e.scrollParents = [], e.scrollElement = null, e.eventsEnabled = !1, e }(this.reference, this.state)) }

    function he(t) { return "" !== t && !isNaN(parseFloat(t)) && isFinite(t) }

    function ue(n, i) { Object.keys(i).forEach(function(t) { var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && he(i[t]) && (e = "px"), n.style[t] = i[t] + e }) }
    ...
    function pe(t, e, n) {
        var i = ie(t, function(t) { return t.name === e }),
    ...
    function be(t, o, r, e) {
        var s = [0, 0],
            ...
            i = n.indexOf(ie(n, function(t) { return -1 !== t.search(/,|\s/) }));
        ...
        })).forEach(function(n, i) { n.forEach(function(t, e) { he(t) && (s[i] += t * ("-" === n[e - 1] ? -1 : 1)) }) }), s
    }
    var we = {
            placement: "bottom",
            positionFixed: !1,
            ...
            modifiers: {
                    ...
                    fn: function(t) {
                        ...
                        if (i) {
                            var o = t.offsets,
                                ...
                                l = a ? "left" : "top",
                                c = a ? "width" : "height",
                                h = { start: Qt({}, l, r[l]), end: Qt({}, l, r[l] + r[c] - s[c]) };
                ...
                offset: {
                    ...
                    fn: function(t, e) {
                        var n = e.offset,
                            ...
                            a = i.split("-")[0],
                            l = void 0;
                        return l = he(+n) ? [+n, 0] : be(n, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], r.left += l[1]) : "top" === a ? (r.left += l[0], r.top -= l[1]) : "bottom" === a && (r.left += l[0], r.top += l[1]), t.popper = r, t
                    },
                    offset: 0
                },
                preventOverflow: {
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        return y = Math.max(Math.min(s[c] - p, y), 0), t.arrowElement = i, t.offsets.arrow = (Qt(n = {}, u, Math.round(y)), Qt(n, f, ""), n), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(d, p) {
                        ...
                        var m = $t(d.instance.popper, d.instance.reference, p.padding, p.boundariesElement, d.positionFixed),
                        ...
                        return y.forEach(function(t, e) {
                            ...
                            var n = d.offsets.popper,
                                ...
                                h = "left" === g && s || "right" === g && a || "top" === g && l || "bottom" === g && c,
                                u = -1 !== ["top", "bottom"].indexOf(g),
                                f = !!p.flipVariations && (u && "start" === v && s || u && "end" === v && a || !u && "start" === v && l || !u && "end" === v && c);
                            (r || h || f) && (d.flipped = !0, (r || h) && (g = y[e + 1]), f && (v = function(t) { return "end" === t ? "start" : "start" === t ? "end" : t }(v)), d.placement = g + (v ? "-" + v : ""), d.offsets.popper = Vt({}, d.offsets.popper, ne(d.instance.popper, d.offsets.reference, d.placement)), d = oe(d.instance.modifiers, d, "flip"))
                        }), d
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                hide: {
                    ...
                    fn: function(t) {
                        ...
                        var e = t.offsets.reference,
                            n = ie(t.instance.modifiers, function(t) { return "preventOverflow" === t.name }).boundaries;
                ...
                computeStyle: {
                    ...
                    fn: function(t, e) {
                        var n = e.x,
                            i = e.y,
                            o = t.offsets.popper,
                            r = ie(t.instance.modifiers, function(t) { return "applyStyle" === t.name }).gpuAcceleration;
        ...
        }, { key: "destroy", value: function() { return function() { return this.state.isDestroyed = !0, re(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"), this.popper.style.position = "", this.popper.style.top = "", this.popper.style.left = "", this.popper.style.right = "", this.popper.style.bottom = "", this.popper.style.willChange = "", this.popper.style[se("transform")] = ""), this.disableEventListeners(), this.options.removeOnDestroy && this.popper.parentNode.removeChild(this.popper), this }.call(this) } }, { key: "enableEventListeners", value: function() { return function() { this.state.eventsEnabled || (this.state = le(this.reference, this.options, this.state, this.scheduleUpdate)) }.call(this) } }, { key: "disableEventListeners", value: function() { return ce.call(this) } }]), Te);
    ...
    Ce.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Ce.placements = me, Ce.Defaults = we;
    var Se = "dropdown",
        De = "bs.dropdown",
        Ie = "." + De,
        Ae = ".data-api",
        ...
        ke = { HIDE: "hide" + Ie, HIDDEN: "hidden" + Ie, SHOW: "show" + Ie, SHOWN: "shown" + Ie, CLICK: "click" + Ie, CLICK_DATA_API: "click" + Ie + Ae, KEYDOWN_DATA_API: "keydown" + Ie + Ae, KEYUP_DATA_API: "keyup" + Ie + Ae },
        Le = "disabled",
        xe = "show",
        Pe = "dropup",
        He = "dropright",
        ...
        ze = "right-start",
        Xe = "left-start",
        Ge = { offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic" },
        $e = { offset: "(number|string|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string" },
        Je = function() {
            ...
            return t.toggle = function() {
                ...
                if (!(this._element.disabled || p(this._element).hasClass(Le) || p(this._menu).hasClass(xe))) {
                    ...
                    p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(xe), p(n).toggleClass(xe).trigger(p.Event(ke.SHOWN, t)))
                }
            }, t.hide = function() {
                if (!this._element.disabled && !p(this._element).hasClass(Le) && p(this._menu).hasClass(xe)) {
                    var t = { relatedTarget: this._element },
                        e = p.Event(ke.HIDE, t),
                        n = c._getParentFromElement(this._element);
                    p(n).trigger(e), e.isDefaultPrevented() || (p(this._menu).toggleClass(xe), p(n).toggleClass(xe).trigger(p.Event(ke.HIDDEN, t)))
                }
            }, t.dispose = function() { p.removeData(this._element, De), p(this._element).off(Ie), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null) }, t.update = function() { this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate() }, t._addEventListeners = function() {
                var e = this;
                p(this._element).on(ke.CLICK, function(t) { t.preventDefault(), t.stopPropagation(), e.toggle() })
            }, t._getConfig = function(t) { return t = l({}, this.constructor.Default, p(this._element).data(), t), m.typeCheckConfig(Se, t, this.constructor.DefaultType), t }, t._getMenuElement = function() {
                if (!this._menu) {
                    var t = c._getParentFromElement(this._element);
                ...
                var t = p(this._element.parentNode),
                    e = Ve;
                return t.hasClass(Pe) ? (e = Ke, p(this._menu).hasClass(Re) && (e = Qe)) : t.hasClass(He) ? e = ze : t.hasClass(je) ? e = Xe : p(this._menu).hasClass(Re) && (e = Ye), e
                    ...
                    for (var e = [].slice.call(document.querySelectorAll(Me)), n = 0, i = e.length; n < i; n++) {
                        ...
                        if (t && "click" === t.type && (s.clickEvent = t), r) {
                            ...
                            if (p(o).hasClass(xe) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(o, t.target))) {
                                ...
                                p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[n].setAttribute("aria-expanded", "false"), p(a).removeClass(xe), p(o).removeClass(xe).trigger(p.Event(ke.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(Ue).length)) : Ne.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Le))) {
            ...
            }, s(c, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "Default", get: function() { return Ge } }, { key: "DefaultType", get: function() { return $e } }]), c
        }();
    p(document).on(ke.KEYDOWN_DATA_API, Me, Je._dataApiKeydownHandler).on(ke.KEYDOWN_DATA_API, Ue, Je._dataApiKeydownHandler).on(ke.CLICK_DATA_API + " " + ke.KEYUP_DATA_API, Je._clearMenus).on(ke.CLICK_DATA_API, Me, function(t) { t.preventDefault(), t.stopPropagation(), Je._jQueryInterface.call(p(this), "toggle") }).on(ke.CLICK_DATA_API, We, function(t) { t.stopPropagation() }), p.fn[Se] = Je._jQueryInterface, p.fn[Se].Constructor = Je, p.fn[Se].noConflict = function() { return p.fn[Se] = Oe, Je._jQueryInterface };
    var Ze = "modal",
        tn = "bs.modal",
        en = "." + tn,
        nn = p.fn[Ze],
        ...
        sn = { HIDE: "hide" + en, HIDDEN: "hidden" + en, SHOW: "show" + en, SHOWN: "shown" + en, FOCUSIN: "focusin" + en, RESIZE: "resize" + en, CLICK_DISMISS: "click.dismiss" + en, KEYDOWN_DISMISS: "keydown.dismiss" + en, MOUSEUP_DISMISS: "mouseup.dismiss" + en, MOUSEDOWN_DISMISS: "mousedown.dismiss" + en, CLICK_DATA_API: "click" + en + ".data-api" },
        ...
        vn = ".sticky-top",
        yn = function() {
            function o(t, e) { this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(dn), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0 }
            var t = o.prototype;
            return t.toggle = function(t) { return this._isShown ? this.hide() : this.show(t) }, t.show = function(t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var n = p.Event(sn.SHOW, { relatedTarget: t });
                    p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(sn.CLICK_DISMISS, gn, function(t) { return e.hide(t) }), p(this._dialog).on(sn.MOUSEDOWN_DISMISS, function() { p(e._element).one(sn.MOUSEUP_DISMISS, function(t) { p(t.target).is(e._element) && (e._ignoreBackdropClick = !0) }) }), this._showBackdrop(function() { return e._showElement(t) }))
                }
            }, t.hide = function(t) {
                var e = this;
                if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(sn.FOCUSIN), p(this._element).removeClass(fn), p(this._element).off(sn.CLICK_DISMISS), p(this._dialog).off(sn.MOUSEDOWN_DISMISS), i) {
                ...
                [window, this._element, this._dialog].forEach(function(t) { return p(t).off(en) }), p(document).off(sn.FOCUSIN), p.removeData(this._element, tn), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, t.handleUpdate = function() { this._adjustDialog() }, t._getConfig = function(t) { return t = l({}, on, t), m.typeCheckConfig(Ze, t, rn), t }, t._showElement = function(t) {
                var e = this,
                    n = p(this._element).hasClass(un);
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(an) ? this._dialog.querySelector(pn).scrollTop = 0 : this._element.scrollTop = 0, n && m.reflow(this._element), p(this._element).addClass(fn), this._config.focus && this._enforceFocus();

                function i() { e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(o) }
                var o = p.Event(sn.SHOWN, { relatedTarget: t });
                if (n) {
                ...
                var e = this;
                p(document).off(sn.FOCUSIN).on(sn.FOCUSIN, function(t) { document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus() })
            }, t._setEscapeEvent = function() {
                var e = this;
                this._isShown && this._config.keyboard ? p(this._element).on(sn.KEYDOWN_DISMISS, function(t) { 27 === t.which && (t.preventDefault(), e.hide()) }) : this._isShown || p(this._element).off(sn.KEYDOWN_DISMISS)
            }, t._setResizeEvent = function() {
                var e = this;
                this._isShown ? p(window).on(sn.RESIZE, function(t) { return e.handleUpdate(t) }) : p(window).off(sn.RESIZE)
            }, t._hideModal = function() {
                var t = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() { p(document.body).removeClass(hn), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(sn.HIDDEN) })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = cn, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(sn.CLICK_DISMISS, function(t) { e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide()) }), n && m.reflow(this._backdrop), p(this._backdrop).addClass(fn), !t) return;
                    if (!n) return void t();
                ...
                return this.each(function() {
                    ...
                    if (t || (t = new o(this, e), p(this).data(tn, t)), "string" == typeof n) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n](i)
                    } else e.show && t.show(i)
                })
            }, s(o, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "Default", get: function() { return on } }]), o
        }();
    p(document).on(sn.CLICK_DATA_API, mn, function(t) {
        ...
        var r = p(e).one(sn.SHOW, function(t) { t.isDefaultPrevented() || r.one(sn.HIDDEN, function() { p(n).is(":visible") && n.focus() }) });
        yn._jQueryInterface.call(p(e), o, this)
    }), p.fn[Ze] = yn._jQueryInterface, p.fn[Ze].Constructor = yn, p.fn[Ze].noConflict = function() { return p.fn[Ze] = nn, yn._jQueryInterface };
    var En = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"],
        bn = { "*": ["class", "dir", "id", "lang", "role", /^aria-[\w-]*$/i], a: ["target", "href", "title", "rel"], area: [], b: [], br: [], col: [], code: [], div: [], em: [], hr: [], h1: [], h2: [], h3: [], h4: [], h5: [], h6: [], i: [], img: ["src", "alt", "title", "width", "height"], li: [], ol: [], p: [], pre: [], s: [], small: [], span: [], sub: [], sup: [], strong: [], u: [], ul: [] },
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(r), a = [].slice.call(n.body.querySelectorAll("*")), i = function(t) {
                ...
                i.forEach(function(t) {
                    ! function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n)) return -1 === En.indexOf(n) || Boolean(t.nodeValue.match(wn) || t.nodeValue.match(Cn));
    ...
    var Sn = "tooltip",
        ...
        Ln = { animation: "boolean", template: "string", title: "(string|element|function)", trigger: "string", delay: "(number|object)", html: "boolean", selector: "(string|boolean)", placement: "(string|function)", offset: "(number|string|function)", container: "(string|element|boolean)", fallbackPlacement: "(string|array)", boundary: "(string|element)", sanitize: "boolean", sanitizeFn: "(null|function)", whiteList: "object" },
        xn = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" },
        Pn = { animation: !0, template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, selector: !1, placement: "top", offset: 0, container: !1, fallbackPlacement: "flip", boundary: "scrollParent", sanitize: !0, sanitizeFn: null, whiteList: bn },
        Hn = "show",
        jn = "out",
        Rn = { HIDE: "hide" + In, HIDDEN: "hidden" + In, SHOW: "show" + In, SHOWN: "shown" + In, INSERTED: "inserted" + In, CLICK: "click" + In, FOCUSIN: "focusin" + In, FOCUSOUT: "focusout" + In, MOUSEENTER: "mouseenter" + In, MOUSELEAVE: "mouseleave" + In },
        Fn = "fade",
        Mn = "show",
        Wn = ".tooltip-inner",
        Un = ".arrow",
        ...
        Vn = function() {
            ...
            return t.enable = function() { this._isEnabled = !0 }, t.disable = function() { this._isEnabled = !1 }, t.toggleEnabled = function() { this._isEnabled = !this._isEnabled }, t.toggle = function(t) {
                ...
                function e() { n._hoverState !== Hn && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t() }
                var n = this,
                    i = this.getTipElement(),
                    o = p.Event(this.constructor.Event.HIDE);
                if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (p(i).removeClass(Mn), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Kn] = !1, this._activeTrigger[qn] = !1, this._activeTrigger[Bn] = !1, p(this.tip).hasClass(Fn)) {
                        var r = m.getTransitionDurationFromElement(i);
                        p(i).one(m.TRANSITION_END, e).emulateTransitionEnd(r)
                    } else e();
                    this._hoverState = ""
                }
            }, t.update = function() { null !== this._popper && this._popper.scheduleUpdate() }, t.isWithContent = function() { return Boolean(this.getTitle()) }, t.addAttachmentClass = function(t) { p(this.getTipElement()).addClass(On + "-" + t) }, t.getTipElement = function() { return this.tip = this.tip || p(this.config.template)[0], this.tip }, t.setContent = function() {
                var t = this.getTipElement();
                this.setElementContent(p(t.querySelectorAll(Wn)), this.getTitle()), p(t).removeClass(Fn + " " + Mn)
            }, t.setElementContent = function(t, e) { "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = Tn(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text()) }, t.getTitle = function() { var t = this.element.getAttribute("data-original-title"); return t = t || ("function" == typeof this.config.title ? this.config.title.call(this.element) : this.config.title) }, t._getOffset = function() {
                var e = this,
                    t = {};
            ...
            }, t._getContainer = function() { return !1 === this.config.container ? document.body : m.isElement(this.config.container) ? p(this.config.container) : p(document).find(this.config.container) }, t._getAttachment = function(t) { return xn[t.toUpperCase()] }, t._setListeners = function() {
                var i = this;
            ...
            }, s(i, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "Default", get: function() { return Pn } }, { key: "NAME", get: function() { return Sn } }, { key: "DATA_KEY", get: function() { return Dn } }, { key: "Event", get: function() { return Rn } }, { key: "EVENT_KEY", get: function() { return In } }, { key: "DefaultType", get: function() { return Ln } }]), i
        }();
    p.fn[Sn] = Vn._jQueryInterface, p.fn[Sn].Constructor = Vn, p.fn[Sn].noConflict = function() { return p.fn[Sn] = An, Vn._jQueryInterface };
    var Yn = "popover",
        zn = "bs.popover",
        Xn = "." + zn,
        Gn = p.fn[Yn],
        ...
        ti = l({}, Vn.DefaultType, { content: "(string|element|function)" }),
        ei = "fade",
        ni = "show",
        ii = ".popover-header",
        oi = ".popover-body",
        ri = { HIDE: "hide" + Xn, HIDDEN: "hidden" + Xn, SHOW: "show" + Xn, SHOWN: "shown" + Xn, INSERTED: "inserted" + Xn, CLICK: "click" + Xn, FOCUSIN: "focusin" + Xn, FOCUSOUT: "focusout" + Xn, MOUSEENTER: "mouseenter" + Xn, MOUSELEAVE: "mouseleave" + Xn },
        si = function(t) {
            ...
            var e = i.prototype;
            return e.isWithContent = function() { return this.getTitle() || this._getContent() }, e.addAttachmentClass = function(t) { p(this.getTipElement()).addClass($n + "-" + t) }, e.getTipElement = function() { return this.tip = this.tip || p(this.config.template)[0], this.tip }, e.setContent = function() {
                var t = p(this.getTipElement());
            ...
            }, s(i, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "Default", get: function() { return Zn } }, { key: "NAME", get: function() { return Yn } }, { key: "DATA_KEY", get: function() { return zn } }, { key: "Event", get: function() { return ri } }, { key: "EVENT_KEY", get: function() { return Xn } }, { key: "DefaultType", get: function() { return ti } }]), i
        }(Vn);
    p.fn[Yn] = si._jQueryInterface, p.fn[Yn].Constructor = si, p.fn[Yn].noConflict = function() { return p.fn[Yn] = Gn, si._jQueryInterface };
    var ai = "scrollspy",
        li = "bs.scrollspy",
        ci = "." + li,
        hi = p.fn[ai],
        ...
        Di = function() {
            function n(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + vi + "," + this._config.target + " " + Ei + "," + this._config.target + " " + wi, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(di.SCROLL, function(t) { return n._process(t) }), this.refresh(), this._process()
            }
            var t = n.prototype;
            return t.refresh = function() {
            ...
            }, t.dispose = function() { p.removeData(this._element, li), p(this._scrollElement).off(ci), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null }, t._getConfig = function(t) {
                if ("string" != typeof(t = l({}, ui, "object" == typeof t && t ? t : {})).target) {
                    var e = p(t.target).attr("id");
                    e || (e = m.getUID(ai), p(t.target).attr("id", e)), t.target = "#" + e
                }
                return m.typeCheckConfig(ai, t, fi), t
                ...
                n.hasClass(pi) ? (n.closest(bi).find(Ci).addClass(mi), n.addClass(mi)) : (n.addClass(mi), n.parents(_i).prev(vi + ", " + Ei).addClass(mi), n.parents(_i).prev(yi).children(vi).addClass(mi)), p(this._scrollElement).trigger(di.ACTIVATE, { relatedTarget: e })
            }, t._clear = function() {
                [].slice.call(document.querySelectorAll(this._selector)).filter(function(t) { return t.classList.contains(mi) }).forEach(function(t) { return t.classList.remove(mi) })
            }, n._jQueryInterface = function(e) {
                return this.each(function() {
                    var t = p(this).data(li);
                    if (t || (t = new n(this, "object" == typeof e && e), p(this).data(li, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
            }, s(n, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "Default", get: function() { return ui } }]), n
        }();
    ...
    }), p.fn[ai] = Di._jQueryInterface, p.fn[ai].Constructor = Di, p.fn[ai].noConflict = function() { return p.fn[ai] = hi, Di._jQueryInterface };
    var Ii = "bs.tab",
        Ai = "." + Ii,
        Oi = p.fn.tab,
        Ni = { HIDE: "hide" + Ai, HIDDEN: "hidden" + Ai, SHOW: "show" + Ai, SHOWN: "shown" + Ai, CLICK_DATA_API: "click" + Ai + ".data-api" },
        ki = "dropdown-menu",
        Li = "active",
        xi = "disabled",
        Pi = "fade",
        ...
        qi = function() {
            ...
            return t.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Li) || p(this._element).hasClass(xi))) {
                    var t, i, e = p(this._element).closest(Ri)[0],
                        o = m.getSelectorFromElement(this._element);
                    if (e) {
                        var r = "UL" === e.nodeName || "OL" === e.nodeName ? Mi : Fi;
                        i = (i = p.makeArray(p(e).find(r)))[i.length - 1]
                    }
                    var s = p.Event(Ni.HIDE, { relatedTarget: this._element }),
                        a = p.Event(Ni.SHOW, { relatedTarget: i });
                    if (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented()) {
                        o && (t = document.querySelector(o)), this._activate(this._element, e);
                        var l = function() {
                            var t = p.Event(Ni.HIDDEN, { relatedTarget: n._element }),
                                e = p.Event(Ni.SHOWN, { relatedTarget: i });
                            p(i).trigger(t), p(n._element).trigger(e)
                        };
                        t ? this._activate(t, t.parentNode, l) : l()
                    }
                }
            }, t.dispose = function() { p.removeData(this._element, Ii), this._element = null }, t._activate = function(t, e, n) {
                ...
                if (e) {
                    ...
                    i && p(i).removeClass(Li), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (p(t).addClass(Li), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), m.reflow(t), t.classList.contains(Pi) && t.classList.add(Hi), t.parentNode && p(t.parentNode).hasClass(ki)) {
    ...
    p(document).on(Ni.CLICK_DATA_API, Wi, function(t) { t.preventDefault(), qi._jQueryInterface.call(p(this), "show") }), p.fn.tab = qi._jQueryInterface, p.fn.tab.Constructor = qi, p.fn.tab.noConflict = function() { return p.fn.tab = Oi, qi._jQueryInterface };
    var Ki = "toast",
        Qi = "bs.toast",
        Vi = "." + Qi,
        Yi = p.fn[Ki],
        zi = { CLICK_DISMISS: "click.dismiss" + Vi, HIDE: "hide" + Vi, HIDDEN: "hidden" + Vi, SHOW: "show" + Vi, SHOWN: "shown" + Vi },
        Xi = "fade",
        Gi = "hide",
        $i = "show",
        Ji = "showing",
        ...
        no = function() {
            ...
            return t.show = function() {
                var t = this;
                p(this._element).trigger(zi.SHOW), this._config.animation && this._element.classList.add(Xi);

                function e() { t._element.classList.remove(Ji), t._element.classList.add($i), p(t._element).trigger(zi.SHOWN), t._config.autohide && t.hide() }
                ...
                var e = this;
                this._element.classList.contains($i) && (p(this._element).trigger(zi.HIDE), t ? this._close() : this._timeout = setTimeout(function() { e._close() }, this._config.delay))
            }, t.dispose = function() { clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains($i) && this._element.classList.remove($i), p(this._element).off(zi.CLICK_DISMISS), p.removeData(this._element, Qi), this._element = null, this._config = null }, t._getConfig = function(t) { return t = l({}, to, p(this._element).data(), "object" == typeof t && t ? t : {}), m.typeCheckConfig(Ki, t, this.constructor.DefaultType), t }, t._setListeners = function() {
                var t = this;
                p(this._element).on(zi.CLICK_DISMISS, eo, function() { return t.hide(!0) })
            }, t._close = function() {
                function t() { e._element.classList.add(Gi), p(e._element).trigger(zi.HIDDEN) }
                var e = this;
                ...
                return this.each(function() {
                    var t = p(this),
                        e = t.data(Qi);
                    if (e || (e = new i(this, "object" == typeof n && n), t.data(Qi, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n](this)
                    }
                })
            }, s(i, null, [{ key: "VERSION", get: function() { return "4.3.1" } }, { key: "DefaultType", get: function() { return Zi } }, { key: "Default", get: function() { return to } }]), i
        }();
    p.fn[Ki] = no._jQueryInterface, p.fn[Ki].Constructor = no, p.fn[Ki].noConflict = function() { return p.fn[Ki] = Yi, no._jQueryInterface },
...
! function(e) {
    if (console.log("does it blend?"), window.innerWidth < 960) {
        var a = e("#searchbar"),
            n = e("#navbarNav");
        a.removeClass("collapse"), a.appendTo(n)
    }
}(jQuery);